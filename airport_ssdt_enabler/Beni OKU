...
WiFi PCIe Yarım Mini kartlarıyla yerel Havaalanını etkinleştirir. 
Bu yöntem, dsdt ve kext düzenlemelerinden kaçınır ve Yazılım Güncellemeleri ve BIOS düzeltmelerine karşı bağışıklık kazanır.
...
3. Havaalanı Kablosuz kartı: IOReg / RP0x / PSXS @ 0 / satıcı kimliği
